...
area_angel = {'A-1' : {'x': 0, 'y': 1.5}, 
            ...
            'A-5-4' : {'x': 8.75, 'y': -1.25},
            'A-5' : {'x': 10, 'y': 1.5},
            'A-5-6' : {'x': 11.25, 'y': -1.25}, 
            'A-6-5' : {'x': 11.25, 'y': -1.25}, 
            'A-6' : {'x': 12.5,  'y': -4},
            'A-6-7' : {'x': 13.75, 'y': -1.25},
            'A-7-6' : {'x': 13.75, 'y': -1.25},
            'A-7' : {'x': 15, 'y': 1.5},
            'A-7-8' : {'x': 16.25, 'y': -1.25}, 
            'A-8-7' : {'x': 16.25, 'y': -1.25}, 
            'A-8' : {'x': 17.5,  'y': -4},
            'A-8-9' : {'x': 18.75, 'y': -1.25},
            'A-9-8' : {'x': 18.75, 'y': -1.25},
            'A-9' : {'x': 20, 'y': 1.5},
            'A-9-2' : {'x': 21.25, 'y': -1.25},
            'A-2-9' : {'x': 21.25, 'y': -1.25},        
            # 3 sensors overlapped for side A
            'A-1-2-3' : {'x': 2.5, 'y': 0}, 
            'A-1-3-2' : {'x': 2.5, 'y': 0}, 
            'A-2-1-3' : {'x': 2.5, 'y': 0}, 
            'A-2-3-1' : {'x': 2.5, 'y': 0}, 
            ...
            'B-5-4' : {'x': 8.75, 'y': -1.25},
            'B-5' : {'x': 10, 'y': 1.5},
            'B-5-6' : {'x': 11.25, 'y': -1.25}, 
            'B-6-5' : {'x': 11.25, 'y': -1.25}, 
            'B-6' : {'x': 12.5,  'y': -4},
            'B-6-7' : {'x': 13.75, 'y': -1.25},
            'B-7-6' : {'x': 13.75, 'y': -1.25},
            'B-7' : {'x': 15, 'y': 1.5},
            'B-7-8' : {'x': 16.25, 'y': -1.25}, 
            'B-8-7' : {'x': 16.25, 'y': -1.25}, 
            'B-8' : {'x': 17.5,  'y': -4},
            'B-8-9' : {'x': 18.75, 'y': -1.25},
            'B-9-8' : {'x': 18.75, 'y': -1.25},
            'B-9' : {'x': 20, 'y': 1.5},
            'B-9-2' : {'x': 21.25, 'y': -1.25},
            'B-2-9' : {'x': 21.25, 'y': -1.25},        
            # 3 sensors overlapped for side B
            'B-1-2-3' : {'x': 2.5, 'y': 0}, 
            'B-1-3-2' : {'x': 2.5, 'y': 0}, 
            'B-2-1-3' : {'x': 2.5, 'y': 0}, 
            'B-2-3-1' : {'x': 2.5, 'y': 0}, 
            ...
            'C-5-4' : {'x': 8.75, 'y': -1.25},
            'C-5' : {'x': 10, 'y': 1.5},
            'C-5-6' : {'x': 11.25, 'y': -1.25}, 
            'C-6-5' : {'x': 11.25, 'y': -1.25}, 
            'C-6' : {'x': 12.5,  'y': -4},
            'C-6-7' : {'x': 13.75, 'y': -1.25},
            'C-7-6' : {'x': 13.75, 'y': -1.25},
            'C-7' : {'x': 15, 'y': 1.5},
            'C-7-8' : {'x': 16.25, 'y': -1.25}, 
            'C-8-7' : {'x': 16.25, 'y': -1.25}, 
            'C-8' : {'x': 17.5,  'y': -4},
            'C-8-9' : {'x': 18.75, 'y': -1.25},
            'C-9-8' : {'x': 18.75, 'y': -1.25},
            'C-9' : {'x': 20, 'y': 1.5},
            'C-9-2' : {'x': 21.25, 'y': -1.25},
            'C-2-9' : {'x': 21.25, 'y': -1.25},        
            # 3 sensors overlapped for side C
            'C-1-2-3' : {'x': 2.5, 'y': 0}, 
            'C-1-3-2' : {'x': 2.5, 'y': 0}, 
            'C-2-1-3' : {'x': 2.5, 'y': 0}, 
            'C-2-3-1' : {'x': 2.5, 'y': 0}, 
            ...
            'D-5-4' : {'x': 8.75, 'y': -1.25},
            'D-5' : {'x': 10, 'y': 1.5},
            'D-5-6' : {'x': 11.25, 'y': -1.25}, 
            'D-6-5' : {'x': 11.25, 'y': -1.25}, 
            'D-6' : {'x': 12.5,  'y': -4},
            'D-6-7' : {'x': 13.75, 'y': -1.25},
            'D-7-6' : {'x': 13.75, 'y': -1.25},
            'D-7' : {'x': 15, 'y': 1.5},
            'D-7-8' : {'x': 16.25, 'y': -1.25}, 
            'D-8-7' : {'x': 16.25, 'y': -1.25}, 
            'D-8' : {'x': 17.5,  'y': -4},
            'D-8-9' : {'x': 18.75, 'y': -1.25},
            'D-9-8' : {'x': 18.75, 'y': -1.25},
            'D-9' : {'x': 20, 'y': 1.5},
            'D-9-2' : {'x': 21.25, 'y': -1.25},
            'D-2-9' : {'x': 21.25, 'y': -1.25},        
            # 3 sensors overlapped for side D
            'D-1-2-3' : {'x': 2.5, 'y': 0}, 
            'D-1-3-2' : {'x': 2.5, 'y': 0}, 
            'D-2-1-3' : {'x': 2.5, 'y': 0}, 
            'D-2-3-1' : {'x': 2.5, 'y': 0}, 
...
def locate_and_predict(cur_side, cur_sensor, cur_time, next_time, filename, counter):
    ...
    # the animal was residing in an overlapped area
        ...
        # deal with corner cases happened around 4 corners
        if cur_side != pre_side_1: 
            if (cur_side == 'D' and pre_side_1 == 'A') or (pre_side_1 == 'D' and cur_side == 'A'): 
                cur_side = 'D'
            else:
                cur_side = cur_side if (ord(cur_side) - ord(pre_side_1) < 0) else pre_side_1   
                
        area_number = cur_side + '-' + cur_sensor + '-' + pre_sensor_1  
        if cur_time - pre_time_2 < time_tolerance:
            if cur_side != pre_side_2: 
                if (cur_side == 'D' and pre_side_2 == 'A') or (pre_side_2 == 'D' and cur_side == 'A'): 
                    cur_side = 'D'
                else:
                    cur_side = cur_side if (ord(cur_side) - ord(pre_side_2) < 0) else pre_side_2
